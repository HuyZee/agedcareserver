...
router.patch('/:id', async (req, res) => {
  ...
  if (updateData.medicare_expiry_date) {
    updateData.medicare_expiry_date = convertToDate(updateData.medicare_expiry_date);
    delete updateData.medicare_expiry_date; // Remove the original key to avoid confusion
  }
